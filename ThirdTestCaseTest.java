...
import java.net.URL;
public class ThirdTestCaseTest {
  ...
  public void thirdTestCase() {
    ...
    driver.findElement(By.cssSelector("*[data-test=\"primary-header\"]")).click();
    driver.findElement(By.id("react-burger-menu-btn")).click();
    driver.findElement(By.cssSelector(".bm-menu")).click();
    {
      WebElement element = driver.findElement(By.cssSelector(".bm-menu"));
      Actions builder = new Actions(driver);
      builder.doubleClick(element).perform();
    }
